...
rv.I("""Hysteretic Damping
    ...
    ====================================================================
    Page 101 - Sec. 3.10 Harmonic Vibration with Rate-Independent Damping
    ====================================================================
    ...
    ED = π*η*k*u0**2 = 2*π*η*E_So       ... (3.10.2)
    ...
    ====================================================================
    Page 102 - Chap. 3 Response to Harmonic and Periodic Excitations
    ====================================================================
    ...
    u(t) = u0 * sin(ω*t - φ)       ... (3.10.4)

    The amplitude u0 and phase angle φ are

    u0 = (u_st)0 * 1 / sqrt( (1 - (ω/ωn)**2)**2 + η**2 )       ... (3.10.5)
    ...
    ζ = c/c_c = (η*k/ω) / (2*m*ωn) = η / (2*(ω/ωn))       ... (3.10.7)
    ...
    ====================================================================
    Page 103 - Sec. 3.10 Harmonic Vibration with Rate-Independent Damping
    ====================================================================
    ...
    ====================================================================
    Page 104 - Chap. 3 Response to Harmonic and Periodic Excitations
    ====================================================================
    ...
    ====================================================================
    Page 105 - Sec. 3.11 Harmonic Vibration with Coulomb Friction
    ====================================================================
...
rv.I("""Hysteretic Damping Example
